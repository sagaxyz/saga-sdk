...
import (
	...
	_ "github.com/sagaxyz/saga-sdk/x/ccv/types"
	io "io"
	math "math"
	math_bits "math/bits"
	time "time"
...
func (m *CrossChainValidator) GetPubkey() *types1.Any {
	if m != nil {
		return m.Pubkey
	}
	return nil
...
var fileDescriptor_5b27a82b276e7f93 = []byte{
	...
	,
}
