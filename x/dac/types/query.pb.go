...
// source: saga/dac/v1/query.proto
...
func init() {
	proto.RegisterType((*QueryParamsRequest)(nil), "saga.dac.v1.QueryParamsRequest")
	proto.RegisterType((*QueryParamsResponse)(nil), "saga.dac.v1.QueryParamsResponse")
	proto.RegisterType((*QueryListAdminsRequest)(nil), "saga.dac.v1.QueryListAdminsRequest")
	proto.RegisterType((*QueryListAdminsResponse)(nil), "saga.dac.v1.QueryListAdminsResponse")
	proto.RegisterType((*QueryListAllowedRequest)(nil), "saga.dac.v1.QueryListAllowedRequest")
	proto.RegisterType((*QueryListAllowedResponse)(nil), "saga.dac.v1.QueryListAllowedResponse")
}

func init() { proto.RegisterFile("saga/dac/v1/query.proto", fileDescriptor_96e01e471f30b2d6) }
...
func (c *queryClient) Params(ctx context.Context, in *QueryParamsRequest, opts ...grpc.CallOption) (*QueryParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/saga.dac.v1.Query/Params", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) ListAllowed(ctx context.Context, in *QueryListAllowedRequest, opts ...grpc.CallOption) (*QueryListAllowedResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/saga.dac.v1.Query/ListAllowed", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) ListAdmins(ctx context.Context, in *QueryListAdminsRequest, opts ...grpc.CallOption) (*QueryListAdminsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/saga.dac.v1.Query/ListAdmins", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Params_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/saga.dac.v1.Query/Params",
	}
...
func _Query_ListAllowed_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/saga.dac.v1.Query/ListAllowed",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_ListAdmins_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/saga.dac.v1.Query/ListAdmins",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Query_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "saga/dac/v1/query.proto",
}
