...
// source: saga/abcdef/packet.proto
...
func (m *AbcdefPacketData) Reset()         { *m = AbcdefPacketData{} }
func (m *AbcdefPacketData) String() string { return proto.CompactTextString(m) }
func (*AbcdefPacketData) ProtoMessage()    {}
func (*AbcdefPacketData) Descriptor() ([]byte, []int) {
	return fileDescriptor_64a9d78dc558c490, []int{0}
}
func (m *AbcdefPacketData) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *AbcdefPacketData) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_AbcdefPacketData.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
...
func (m *AbcdefPacketData) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AbcdefPacketData.Merge(m, src)
}
func (m *AbcdefPacketData) XXX_Size() int {
	return m.Size()
}
func (m *AbcdefPacketData) XXX_DiscardUnknown() {
	xxx_messageInfo_AbcdefPacketData.DiscardUnknown(m)
}

var xxx_messageInfo_AbcdefPacketData proto.InternalMessageInfo

type isAbcdefPacketData_Packet interface {
	isAbcdefPacketData_Packet()
...
func (m *AbcdefPacketData) GetNoData() *NoData {
	if x, ok := m.GetPacket().(*AbcdefPacketData_NoData); ok {
		return x.NoData
	}
	return nil
}
...
func (*NoData) Descriptor() ([]byte, []int) {
	return fileDescriptor_64a9d78dc558c490, []int{1}
}
...
var fileDescriptor_64a9d78dc558c490 = []byte{
	...
	,
}
...
func (m *AbcdefPacketData) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *AbcdefPacketData) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *AbcdefPacketData_NoData) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *AbcdefPacketData_NoData) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.NoData != nil {
		{
...
func (m *AbcdefPacketData) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *AbcdefPacketData_NoData) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *AbcdefPacketData) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		if wireType == 4 {
			return fmt.Errorf("proto: AbcdefPacketData: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: AbcdefPacketData: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			m.Packet = &AbcdefPacketData_NoData{v}
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
