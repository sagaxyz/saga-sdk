...
import (
	...
	"github.com/sagaxyz/saga-sdk/x/abcdef/client/cli"
...
type AbcdefOutputs struct {
	depinject.Out

	AbcdefKeeper keeper.Keeper
	Module         appmodule.AppModule
}

func ProvideModule(in AbcdefInputs) AbcdefOutputs {
	// default to governance authority if not provided
	authority := authtypes.NewModuleAddress(govtypes.ModuleName)
	if in.Config.Authority != "" {
		authority = authtypes.NewModuleAddressOrBech32Address(in.Config.Authority)
	}
	scopedVoteKeeper := in.CapabilityKeeper.ScopeToModule(types.ModuleName)
	k := keeper.NewKeeper(
		in.Cdc,
		in.KvStoreKey,
		in.MemStoreKey,
	...
	return AbcdefOutputs{AbcdefKeeper: k, Module: m}
}*/
