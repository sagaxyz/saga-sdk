...
// source: saga/acl/v1/address.proto
...
func (AddressFormat) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_3dacbc1a0609332a, []int{0}
}

type Address struct {
	Format AddressFormat `protobuf:"varint,1,opt,name=format,proto3,enum=saga.acl.v1.AddressFormat" json:"format,omitempty"`
...
func init() {
	proto.RegisterEnum("saga.acl.v1.AddressFormat", AddressFormat_name, AddressFormat_value)
	proto.RegisterType((*Address)(nil), "saga.acl.v1.Address")
}

func init() { proto.RegisterFile("saga/acl/v1/address.proto", fileDescriptor_3dacbc1a0609332a) }

var fileDescriptor_3dacbc1a0609332a = []byte{
	// 238 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x92, 0x2c, 0x4e, 0x4c, 0x4f,
	0xd4, 0x4f, 0x4c, 0xce, 0xd1, 0x2f, 0x33, 0xd4, 0x4f, 0x4c, 0x49, 0x29, 0x4a, 0x2d, 0x2e, 0xd6,
	...
	0x31, 0x20, 0x00, 0x00, 0xff, 0xff, 0x9d, 0xef, 0x08, 0x5a, 0x17, 0x01, 0x00, 0x00,
}
